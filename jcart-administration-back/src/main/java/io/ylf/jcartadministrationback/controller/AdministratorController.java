...
import io.ylf.jcartadministrationback.enumeration.AdministratorStatus;
...
import io.ylf.jcartadministrationback.util.JWTUtil;
...
public class AdministratorController {
    ...
    public Integer create(@RequestBody AdministratorCreateInDTO administratorCreateInDTO){
        ...
        administrator.setRealName(administratorCreateInDTO.getRealNum());
    ...
    public void update(@RequestBody AdministratorUpdateInDTO administratorUpdateInDTO){
        ...
        administrator.setRealName(administratorUpdateInDTO.getRealNum());
